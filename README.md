# Aprenda Kotlin Com Exemplos: Desafio de Projeto da DIO

Desafio de Projeto criado para avaliação do conteúdo técnico explorado na formação da linguagem Kotlin. Nesse contexto, iremos abstrair o seguinte domínio de aplicação:
